...
const ServiceCard = ({item, index}) => {
  ...
  return (
    <div className='py-[30] px-3 lg:px-5'>
        ...
        <p className='text-[16px] leading-7 font-[400] text-textColor mt-4 text-justify'>{desc}</p>
        ...
        <Link to='/clinics' className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none">
                ...
                <span className='w-[44px] h-[44px] flex item-center justify-center text-[20px] leading-[45px] font-[400]' style={{background:`${bgColor}`, color:`${textColor}`,borderRadius: "6px 0 0 6px" }}>
    {index+1}
                </span>
        </div>
