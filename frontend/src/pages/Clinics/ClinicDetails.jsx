...
const ClinicDetails = () => {
  ...
  const firstPageDisplay = location.pathname === '/clinics/01';
  const secondPageDisplay = location.pathname === '/clinics/02';
  const ThirdPageDisplay = location.pathname === '/clinics/03';
if(firstPageDisplay){
  return <section> 
  ...
  else if (secondPageDisplay)
  {
      ...
      <div className = 'grid md:grid-cols-3 gap-[50px]'> 
        <div className = 'md:col-span-2'>
          <div className = 'flex items-center gap-5'>  
            ...
            <div className = 'lg:w-[500px] md:w-[500px]'>
            <span className = 'bg-[#c9f0f2] text-[#026a6e] py-1 px-5 lg:py-1 lg:px-5 text-[12px] lg:text-[12px] lg:leading-10 font-semibold rounded'> Clinical Hub </span>
            <h3 className = 'text-headingColor text-[20px] leading-10 mt-3 font-bold'> Giza Clinic </h3>
              <div className = 'flex items-center gap-[6px]'/>
              <span className = 'flex items-center gap-[6px] text-[14px] leading-10 lg:text-[16px] lg:leading-10 font-semibold text-headingColor'> 
                <img src = {starImg} alt = ""/> 4.8
              </span>
        ...
        <div className = 'grid md:grid-cols-3 gap-[50px]'> 
          <div className = 'md:col-span-2'>
            <div className = 'flex items-center gap-5'>  
              ...
              <div className = 'lg:w-[500px] md:w-[500px]'>
              <span className = 'bg-[#c9f0f2] text-[#026a6e] py-1 px-5 lg:py-1 lg:px-5 text-[12px] lg:text-[12px] lg:leading-10 font-semibold rounded'> Clinical Hub </span>
              <h3 className = 'text-headingColor text-[20px] leading-10 mt-3 font-bold'> Old Cairo Clinic </h3>
                <div className = 'flex items-center gap-[6px]'/>
                <span className = 'flex items-center gap-[6px] text-[14px] leading-10 lg:text-[16px] lg:leading-10 font-semibold text-headingColor'> 
                  <img src = {starImg} alt = ""/> 4.8
                </span>
    ...
    return <p> ERR:4O4 Not Found</p>; // Do not render anything if the path does not match
  }
};
